...
public class ProfileComplete extends AppCompatActivity implements WebCompleteTask {
...
//                }
        ...
        binding.uploadLogoLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                upLogo = true;
                seller = false;
        ...
        binding.sellerImageLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                upLogo = false;
                seller = true;
        ...
        binding.uploadCancelChequeLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                upLogo = false;
                seller = false;
        ...
        binding.uploadPanCompyLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                upLogo = false;
                seller = false;
    ...
    public void setFieldData() {
        try {
            ...
            if (Utils.checkEmptyNull(user_kyc.optString("address_1")))
                binding.pickupAddressEt.setText(user_kyc.optString("address_1"));
    ...
    public void setData() {
        if (getIntent().getExtras() != null) {
            try {
                ...
                if (user_kyc.optString("city_id") != null && cityID.size() > 0) {
...
//                startActivityForResult(i, 100);
    ...
    public void profileStep1() {
        ...
        } else if (TextUtils.isEmpty(pin_id)) {
            retryAlertDialog(getString(R.string.app_name), getString(R.string.pincode_required) + "gfhdh dfgh");
            count--;
        ...
        } else if (TextUtils.isEmpty(binding.businessRegNoEt.getText())) {
            count--;
            retryAlertDialog(getString(R.string.app_name), getString(R.string.business_reg_no) + "required");
...
//                    Bitmap bitmap = ((BitmapDrawable)binding.sellerImage.getDrawable()).getBitmap();
                    ...
                    bitmap.compress(Bitmap.CompressFormat.PNG, 80 /*ignored for PNG*/, bos);
                    byte[] bitmapdata = bos.toByteArray();
                    Log.d("bit_image2", bitmapdata.toString());
                    //write the bytes in file
            ...
            RequestBody delivery_pincode = RequestBody.create(MediaType.parse("text/plain"), binding.deliveryPinSpinner.getSelectedItem() + "");
