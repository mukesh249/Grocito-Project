...
//                }
    ...
    public void RegistrationApi() {
        ...
        if (TextUtils.isEmpty(binding.etName.getText().toString().trim())) {
           Utils.isEmpty(Registration.this,binding.etName.toString().trim(),"Name is Required");
        } else if (TextUtils.isEmpty(binding.etEmail.getText().toString().trim())) {
            Utils.isEmpty(Registration.this,binding.etEmail.toString().trim(),getResources().getString(R.string.email_required));
        ...
        if (RequestCode.CODE_Register == taskcode){
            ...
            try {
                ...
                if (jsonObject.getInt("status_code") == 1) {
                    Utils.Tosat(Registration.this,jsonObject.optString("message"));
                    finish();
                }else {
