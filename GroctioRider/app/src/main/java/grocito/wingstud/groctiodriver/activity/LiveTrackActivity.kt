...
class LiveTrackActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val destLng: String by lazy {
        if (trackUser) assignedOrder.user_long else assignedOrder.seller_long
    }

    private val destLat: String by lazy {
        if (trackUser) assignedOrder.user_lat else assignedOrder.seller_lat
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title_tv.text = if (trackUser) assignedOrder.user_address else assignedOrder.seller_address
        sub_title_tv.text = if (trackUser) assignedOrder.user_address else assignedOrder.seller_name
