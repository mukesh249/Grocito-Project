...
import in.wingstud.grocitoseller.Api.BackGroundApi;
...
import static in.wingstud.grocitoseller.Api.AppConfig.BASE_URL;
...
public class ProductUpload extends AppCompatActivity implements WebCompleteTask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.selectImageLL.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                        dismissProgressBar();
    ...
    public void getsearchData(JSONObject dataObject) {
        dialog.dismiss();
        binding.productNameEt.setEnabled(false);
        binding.brandSpinner.setEnabled(false);
        binding.productDesEt.setEnabled(false);
        ...
        product_id = dataObject.optString("id");
        ...
        if (dataObject.has("main_category")) {
            List<String> list = new ArrayList<String>();
            list.add(dataObject.optJSONObject("main_category").optString("name"));
            cat_id = dataObject.optJSONObject("main_category").optString("id");

            Log.i("main_category_df", dataObject.optJSONObject("main_category").optString("name"));
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, list);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            binding.mainCatSpinner.setAdapter(adapter);
        }

        if (dataObject.has("sub_category")) {
            List<String> list = new ArrayList<String>();
            list.add(dataObject.optJSONObject("sub_category").optString("name"));

            Log.i("sub_category_df", dataObject.optJSONObject("sub_category").optString("name"));
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, list);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
